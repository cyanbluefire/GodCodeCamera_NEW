...
import com.uboss.godcodecamera.app.MyUtil.ImageBucket;
	...
	private class PreviewListener implements OnClickListener {
		public void onClick(View v) {
			if (Bimp.tempSelectBitmap.size() > 0) {
				...
				intent.setClass(MyAlbumActivity.this, GalleryActivity.class);
...
//				new CameraActivity.SavePicTask(baos.toByteArray(),MyAlbumActivity.this);
	...
	private class BackListener implements OnClickListener {
		public void onClick(View v) {
			intent.setClass(MyAlbumActivity.this, ImageFile.class);
			startActivity(intent);
		}
	}
...
//		}
		gridImageAdapter = new AlbumGridViewAdapter(MyAlbumActivity.this,dataList, Bimp.tempSelectBitmap);
